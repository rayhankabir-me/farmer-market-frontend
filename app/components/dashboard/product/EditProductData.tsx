  ...
  const submitForm = async (formData) => {
    try {
      const response = await axios.put(
        process.env.NEXT_PUBLIC_BACKEND_API + "/api/edit-product/" + currentId,
        formData,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          ...
          <div className="px-4 py-8 w-full">
            <form onSubmit={handleSubmit(submitForm)}>
              <div className="mb-5">
                ...
                <input
                  {...register("Name", {
                    required: "Your must fill Product Name...",
                  })}
                  type="text"
                  id="Name"
                  name="Name"
              ...
              <div className="mb-5">
                ...
                <textarea
                  {...register("Description", {
                    required: "Your must fill Product description..",
                  })}
                  id="Description"
                  name="Description"
              ...
              <div className="mb-5">
                ...
                <input
                  {...register("Price", {
                    required: "Your must fill Product Price...",
                  })}
                  type="text"
                  id="Price"
                  name="Price"
              ...
              <div className="mb-5">
                ...
                <input
                  {...register("Stock", {
                    required: "Your must fill Product Stock...",
                  })}
                  type="number"
                  id="Stock"
                  name="Stock"
                ...
                >
                  {categories.map((category) => (
                    <option
                      ...
                      selected={
                        category.CategoryId == productData.Category.CategoryId
                      }
                    >
                      {category.Name}
                    </option>
